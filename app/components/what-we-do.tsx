          ...
          body={
            <>
              <p>
                ...
                <strong>Boston area non-profits</strong> under the guidance of a
                Project Manager, Tech Lead, and Designer.
              </p>
              <p>
                Students gain{" "}
        ...
        <Card
          ...
          body={
            <>
              ...
              <p>
                Teams work together to exchange ideas, strengthen their skills,
                and <strong>tackle real-world challenges</strong> in a
        ...
        <Card
          ...
          body={
            <>
              ...
              <p>
                JumboCode events serve members and the broader Tufts community,
                uniting students across disciplines.
              </p>
            </>
          }
