    ...
    <div className="mx-auto w-full max-w-7xl px-20">
        <div className="flex flex-col md:flex-row justify-between mt-10 gap-5 md:gap-20">
            ...
            <div className="md:ml-auto">
                <h4 className="font-bold hover:opacity-50 transition-opacity duration-200" id="email-header"><a href="mailto:board@jumbocode.org" target="_blank">board@jumbocode.org</a></h4>
